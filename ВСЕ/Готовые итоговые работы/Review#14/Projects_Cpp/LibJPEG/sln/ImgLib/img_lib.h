...
public:
    ...
    // шаг задаёт смещение соседних строк изображения он обычно совпадает с шириной, но может быть больше неё
    int GetStep() const;

    // будем считать изображение корректным, если его площадь положительна
